...
$(document).ready(function(){
    ...
    var a4_page_height_mm = 210 - 20 - 40;
    ...
    if (page_numbers > 1){
		...
		var os_coef = 0;
    if (navigator.appVersion.indexOf("Linux")!=-1) os_coef = 50;
		var page_numbers_without_bottom = Math.ceil((content_height_px - $('div.bottom').outerHeight() - $('div.comment').outerHeight() - os_coef) / a4_page_height_px);
